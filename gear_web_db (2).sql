...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 16, 2021 lúc 04:45 AM
...
(1, 'Phan Thế', 'Hiếu', 'phan2001hieu@gmail.com', '0909607426', '123', b'01', 1, ''),
(2, 'Trương Nhật', 'Vy', 'nhatvy.truong1@gamil.com', '0814840484', '123', b'01', 0, ''),
(3, 'Phan Thế', 'Hiếu', 'phanhieu110101@gmail.com', '0935357395', '123', b'11', 0, '');
...
--
ALTER TABLE `danhmuc`
  MODIFY `MaDanhMuc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `sanpham`
  MODIFY `MaSanPham` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `taikhoan`
  MODIFY `MaTaiKhoan` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
