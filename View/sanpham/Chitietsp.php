<?php
  ...
  include('../../Controller/sanPham_C.php');
  $sanPhamController = new SanPham_C;
  $cart = new Cart_C;
  // include ('../../Controller/showsanpham.php');
  // $p = new showsanpham_controller;
  // $tieude = $p->getName(); 
  // include ('../../Controller/spshow.php');
  // $pa = new spshow_controller;
  // $ketquasp = $pa->getshow();
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="row">
          <div class="col-xs-12">
            <ul>
              ...
              <?php
                $id = $_GET['SP'];
                $sanPham = $sanPhamController->sanPhamtheoID($id);
                while ($rows = mysqli_fetch_array($sanPham)){
                  ...
                  $Gia = $rows['Gia'];
                  $MaThuongHieus = $rows['MaThuongHieu'];
                  $MaDanhMucs = $rows['MaDanhMuc'];
                }
