              ...
              <article class="col-main">
                ...
                <div class="category-products">
                  ...
                  for($i = 0 ; $i < sizeof($spoke); $i++){
                      ...
                      <div class="item-inner">
                        <div class="item-img">
                          <div class="item-img-info"> <a href="chitietsp.php?SP='.$spoke[$i]['MaSanPham'].'" title="Sample Product" class="product-image"> <img src="../../products-images/'.$spoke[$i]['Anh'].'" alt="Sample Product"> </a>
                          </div>
                        </div>
                        <div class="item-info">
                          <div class="info-inner">
