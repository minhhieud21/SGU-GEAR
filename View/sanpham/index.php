      ...
      <div class="container">
        <div class="row">
          <div class="offer-inner col-lg-12">
            <div class="left">
              <div class="col-1"><a href="#"><img src="../../images/offer-banner1.jpg" alt="offer banner1"></a></div>
              <div class="col mid">
                <a href="#"><img src="../../images/offer-banner2.jpg" alt="offer banner2"></a>
              </div>
              <div class="col last">
                <a href="#"><img src="../../images/offer-banner3.jpg" alt="offer banner2"></a>
              </div>
            </div>
            <div class="right">
              <div class="col">
                <a href="#" title=""><img src="../../images/offer-banner4.jpg" alt=""></a>
              </div>
            </div>
          </div>
        </div>
        ...
        for ($j = 0 ; $j < sizeof ($ketquasp) ; $j ++){
          ...
          echo '<div class="item">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"> <a class="product-image" title="Sample Product" href="chitietsp.php?SP='.$ketquasp[$j]['MaSanPham'].'"> <img alt="Sample Product" src="../../products-images/'.$ketquasp[$j]['Anh'].'"> </a>
                      </div>
                    </div>
                    <div class="item-info">
