...
<body>
                ...
                <table class="data-table cart-table" id="shopping-cart-table">
                    ...
                    <tbody>
                        <tr class="first odd">
                            ...
                            <td class="a-center hidden-table">
                                <h2 class="cart-price">
                                    <h2 class="price">$ <?= number_format($item['Price'] * $item['Quantity'], 0, ',', ',') ?> </h2>
                                </h2>
                            </td>
                        </tr>
                    </tbody>
    ...
    if (isset($_REQUEST['thanhToan'])) {
        ...
        $donHang = ["MaKhachHang" => $maKhachHang, "NgayMua" => $ngayMua, "TongTien" => $tongTien, "TinhTrang" => $tinhTrang,
                    "HoTen" => $hoten,"Email" => $email,"Sdt" => $sdt,"DiaChi" => $diaChi,"TinhThanh" => $tinhThanh,"QuanHuyen" => $quanHuyen];
