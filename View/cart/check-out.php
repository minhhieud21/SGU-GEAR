                ...
                <form action="payment.php" method="get">
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input name="hoTen" type="text" class="form-control" id="validationCustom01" placeholder="Họ tên" value="" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-7 mb-3">
                            <h5 for="validationCustom01">Email</h5>
                            <input name="email" type="text" class="form-control" id="validationCustom01" placeholder="Email" value="" required>
                        </div>
                        <div class="col-md-5 mb-3">
                            <h5 for="validationCustom01">Số điện thoại</h5>
                            <input name="sdt" type="text" class="form-control" id="validationCustom01" placeholder="Số điện thoại" value="" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                ...
                <table class="data-table cart-table" id="shopping-cart-table">
                    ...
                    <tbody>
                        <tr class="first odd">
                            ...
                            <td class="a-center hidden-table">
                                <h2 class="cart-price">
                                    <h2 class="price"> <?= number_format($item['Quantity'] * $item['Price'], 0, ',', ',') ?> </h2>
                                </h2>
                            </td>
                        </tr>
                    </tbody>
