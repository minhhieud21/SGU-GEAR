                                    ...
                                    <table data-toggle="table" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="price" data-sortable="true">Thông tin thương hiệu</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Logitech</td>
                                                <td>Thương hiệu lớn.....</td>
                                                <td>
                                                    <div class="rf" style="display: flex; justify-content: space-around;">
                                                        <a href=""><i class="glyphicon glyphicon-trash"></i></a>
                                                        <a href="update-trademark.php"><i class="glyphicon glyphicon-pencil"></i></a>
                                                    </div>
