                        ...
                        <div class="col-md-12">
                            <form role="form">
                                <div class="form-group">
                                    <label>Họ Lót</label>
                                    <input class="form-control" id="holot" name="holot" value="">
                                </div>
                                <div class="form-group">
                                    <label>Tên</label>
                                    <input class="form-control" id="ten" name="ten" value="">
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                ...
                                <div class="form-group" style="text-align: center;">
                                    <button type="submit" class="btn btn-info" style=""><i class="glyphicon glyphicon-floppy-saved"></i> Lưu</button>
