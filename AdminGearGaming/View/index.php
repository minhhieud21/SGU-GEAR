						...
						<div class="bootstrap-table">
							<div class="fixed-table-toolbar">
								<div class="btn pull-left">
									<a class="btn btn-default" href="insert-product.php"><i class="glyphicon glyphicon-plus-sign" style="margin-top: 1px"></i> Thêm</a>
											...
											<tr>
												...
												<td>
													<div class="rf" style="display: flex; justify-content: space-around;">
														...
														<a href="update-product.php"><i class="glyphicon glyphicon-pencil"></i></a>
													</div>
